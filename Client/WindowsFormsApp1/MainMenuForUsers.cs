...
{
    public partial class MainMenuForUsers : Form
    {
        string login;

        public MainMenuForUsers(string data)
        {
            InitializeComponent();
        ...
        {            
            OpenChildForm(new Parcels_Users(login), sender);            
        }

        private void button2_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Warehouses_Users(), sender);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Admins_Users(login), sender);           
        }
